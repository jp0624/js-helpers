...
function Default() {
	...
	let loadedData: any = {
		code01: FileImporter(
			`${currentHost}/src/_db/sections/fundamentals/functions/function_scope/code_01.txt`
		),
		code02: FileImporter(
			`${currentHost}/src/_db/sections/fundamentals/functions/function_scope/code_02.txt`
		),
	}
	return (
		<>
